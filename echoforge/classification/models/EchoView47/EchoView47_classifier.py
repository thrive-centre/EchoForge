...
def build_echoview47_classifier(input_shape=(224, 224, 3), num_classes=47, pretrained=True):
    """
    ...
    """
    if pretrained:
        print("\n Loading pretrained EchoView47 classifier from Hugging Face...")
        model_path = download_model("EchoView47_classifier")
